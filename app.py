...
# from logic import go, topological
...
def main():
    ...
    if request.method == "GET":
        return render_template("index.html", form=factForm, choice=askForm, ask=ask, process=process, res=res, cnt=cnt,question=question)
